function[] = fPlotEtaHx(Xb,xInterp,Yb,yInterp,write2disc)
...
plot1(3) = plot(Xb(:,1),Yb(:,1),'Parent',axes1,...
    ...
    'Color',colors(9,:),...
    'DisplayName','Combined a_*\cdot b_* / H_*^2');
...
% Create xlabel
xlabel('Ratio of constriction dimension and backwater [-]','FontSize',fontS,'FontName','Arial');
% Create ylabel
...
if write2disc
    cd('figures');
    export_fig etaHx.png -png
    export_fig etaHx.eps -eps
    cd ..
