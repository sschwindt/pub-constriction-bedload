...
coeffsFr = xlsread(sourceName, 2, 'D24:F26');
coeffshx = nan(size(coeffsFr));
...
% PREPARE DATA ------------------------------------------------------------
interXhx = 0.39:0.01:0.5;
interXFr = 0.15:0.01:0.98;
...
YFr = Y;
YbFr = Yb;
fPlotEtahxFr(Xhx,Xbhx,xInterphx,Yhx,Ybhx,yInterphx, ...
